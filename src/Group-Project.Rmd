...
# *Should we standardize the data for median sales price and median list price.*
[Info](https://www.egnyte.com/guides/life-sciences/data-standardization)
[Housing Price Example](https://towardsdatascience.com/predicting-house-prices-with-linear-regression-machine-learning-from-scratch-part-ii-47a0238aeac1)

```{r}
# These are the standardization formulals
# state_market.df$stan_median_sale_price <- (state_market.df$median_sale_price - mean(state_market.df$median_sale_price)) / sd(state_market.df$median_sale_price)
# state_market.df$stan_median_list_price <- (state_market.df$median_list_price - mean(state_market.df$median_list_price)) / sd(state_market.df$median_list_price)
```
